...
describe('jKif.Thinker #isConsistentSentential', function() {
  ...
  xit('should return a Boolean value', function() {
  ...
  xit('should return true for single fact knowledgebases', function() {
  ...
  xit('should return true for multiple fact knowledgebases where the facts are unrelated', function() {
  ...
  xit('should return false for multiple fact knowledgebases where the facts contradict each other', function() {
