    ...
    if (newNode.length) {
      switch (newNodeType) {
        case 'negation':
          ...
          if (negationReturn[0] === 'negatedDisjunction') {
            this.addToAllOpenStacks([negationReturn[1], negationReturn[2], negationReturn[3]]);
          } else if (negationReturn[0] === 'negatedRelSent') {
            this.addToAllOpenStacks([negationReturn[1]]);
          }
          break;
        case 'conjunction':
