...
function constructFromStack(stack) {
  ...
  while (stack.length && !checked) {
    ...
    checked = stack.reduce(this.stackReducer.bind(this), true);
  }
}
 ...
 */
function manageBranchingStacks(clonedStacks, disjunctionNodes) {
  this.addToAllOpenStacks([disjunctionNodes[0]]);
  this.addNodeToAllClonedStacks(clonedStacks, disjunctionNodes[1]);
